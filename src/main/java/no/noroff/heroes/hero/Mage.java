...
public class Mage extends Hero{
    ...
    @Override
    public void damage() {
        total_mage_attribute = WeaponDamage * (1+ (levelAttribute.getStrength()/100));
        System.out.println("total damage: " + total_mage_attribute);
    ...
    public void totalAttributes() {
        ...
        total_mage_damage = (levelAttribute.getStrength() +
